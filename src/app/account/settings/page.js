    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 border border-transparent hover:border-gray-200 transition-all cursor-pointer">
                    <div>
                ...
                <div className="flex items-center justify-between p-4 rounded-2xl bg-red-50 border border-transparent hover:border-red-100 transition-all cursor-pointer mt-12">
                    <div>
