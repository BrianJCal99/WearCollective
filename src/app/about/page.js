  ...
  return (
    <div className="bg-white">
      ...
      <div className="bg-gray-900 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Trusted by thousands worldwide</h2>
      ...
      <div className="mt-24 sm:mt-32 xl:mx-auto xl:max-w-7xl px-6 lg:px-8">
        <img
          src="https://iheaqdluewqbcbcunigk.supabase.co/storage/v1/object/public/brand_logo/logo_1920x1080px.jpg"
