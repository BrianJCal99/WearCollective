            ...
            <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                <section id="size-guides" className="mb-20">
                    <div className="flex items-center mb-8">
                        ...
                        <h3 className="text-2xl font-bold text-gray-900">Size Guides</h3>
                    </div>
                        ...
                        <div className="p-8">
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-sm text-left text-gray-500">
                                            ...
                                            <tbody className="divide-y divide-gray-100">
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">XS</td><td className="px-4 py-3">34-36</td><td className="px-4 py-3">28-30</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">S</td><td className="px-4 py-3">36-38</td><td className="px-4 py-3">30-32</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">M</td><td className="px-4 py-3">38-40</td><td className="px-4 py-3">32-34</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">L</td><td className="px-4 py-3">40-42</td><td className="px-4 py-3">34-36</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">XL</td><td className="px-4 py-3">42-45</td><td className="px-4 py-3">36-39</td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full text-sm text-left text-gray-500">
                                            ...
                                            <tbody className="divide-y divide-gray-100">
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">28</td><td className="px-4 py-3">28-29</td><td className="px-4 py-3">34-35</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">30</td><td className="px-4 py-3">30-31</td><td className="px-4 py-3">36-37</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">32</td><td className="px-4 py-3">32-33</td><td className="px-4 py-3">38-39</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">34</td><td className="px-4 py-3">34-35</td><td className="px-4 py-3">40-41</td></tr>
                                                <tr><td className="px-4 py-3 font-medium text-gray-900">36</td><td className="px-4 py-3">36-37</td><td className="px-4 py-3">42-43</td></tr>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div className="mt-12 bg-blue-50 rounded-2xl p-6 border border-blue-100">
                                <div className="flex">
                                    ...
                                    <div>
                                        <h5 className="text-blue-900 font-semibold mb-1">How to measure yourself?</h5>
                ...
                <section id="care-instructions" className="mb-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                            ...
                            <h4 className="text-lg font-bold text-gray-900 mb-3">Washing</h4>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                            ...
                            <h4 className="text-lg font-bold text-gray-900 mb-3">Drying</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                            ...
                            <h4 className="text-lg font-bold text-gray-900 mb-3">Repairs</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-8">
                            <div className="space-y-8">
                                <div>
                                    <h4 className="text-lg font-semibold text-gray-900 mb-3">Ethical Manufacturing</h4>
                                ...
                                <div className="pt-8 border-t border-gray-100">
                                    <h4 className="text-lg font-semibold text-gray-900 mb-3">Our Materials</h4>
