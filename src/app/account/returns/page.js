    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center border-2 border-dashed border-gray-200 rounded-3xl">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">No active returns</h4>
                <p className="text-gray-500 mb-8 max-w-xs mx-auto">
                    You don't have any items currently being returned or refunded.
                </p>
                <button className="bg-gray-900 text-white px-8 py-3 rounded-xl font-bold transition-transform hover:scale-105">
                    Start a New Return
                </button>
            </div>
            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <h4 className="text-blue-900 font-bold mb-2">Quick Return Tip</h4>
