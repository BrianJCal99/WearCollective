            ...
            <div className="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">30-Day Return Window</h3>
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-200">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 mb-2">Condition for Return</h3>
                        <p className="text-gray-600">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-3">Methods of Refund</h4>
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-900 mb-3">Shipping Costs</h4>
                                    <p className="text-gray-600 text-sm">
                            ...
                            <div className="mt-10 pt-10 border-t border-gray-100">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-gray-900 mb-1">Non-Returnable Items</h4>
                                        <p className="text-gray-600 text-sm">
...
const ProcessStep = ({ number, title, description }) => (
    <div className="flex bg-white p-6 rounded-2xl border border-gray-100">
        <div className="text-2xl font-black text-gray-200 mr-6 w-8 shrink-0">
            {number}
        </div>
        <div>
